...
var allComments []models.GetAllCommentsWithUserAndPhoto

func (c *CommentService) CreateComment(request models.CreateComment) *models.Response {
...
func (c *CommentService) GetAllComments() *models.Response {
	allComments = nil
	...
	for _, com := range *comments {
		allComments = append(allComments, models.GetAllCommentsWithUserAndPhoto{
			ID:        com.ID,
			Message:   com.Message,
			PhotoID:   com.PhotoID,
			UserID:    com.UserID,
...
func (c *CommentService) UpdateComment(request models.CreateComment) *models.Response {
	comment := models.Comment{
		Message: request.Message,
	}
...
func (c *CommentService) DeleteComment(request models.CreateComment) *models.Response {
	checkData, err := c.commentRepo.GetCommentByID(request.ID)
